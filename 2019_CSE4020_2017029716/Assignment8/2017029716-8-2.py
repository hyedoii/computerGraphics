...
def drawCube_glDrawElements():
    global gVertexArraySeparate, iarr, varr
...
def main():
    global gVertexArraySeparate , varr, iarr
    if not glfw.init():
        return
    window = glfw.create_window(480,480,'2017029716-8-2', None,None)
    if not window:
        glfw.terminate()
        return
    ...
    varr , iarr = createVertexArrayElement()
